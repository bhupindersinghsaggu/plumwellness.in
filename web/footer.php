            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-xl-3">
                        <h4 class="footer-title pq-footer-link">About</h4>
                        <p class="pq-footer-disc">we offer personalized nutrition coaching tailored to your unique needs
                            and lifestyle. Our certified experts create sustainable, science-backed plans to help you
                    ...
                    <div class="col-lg-3 col-md-6 col-xl-3">
                        <h4 class="footer-title pq-footer-link">our service</h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-xl-3">
                        <h4 class="footer-title pq-footer-contact">Contact us</h4>
                        <ul class="pq-contact">
                            <li>
                                <span><a href="tel:+919988993972"><i class="fas fa-phone"></i>
                                        +91 99889 93972</span>
                            </li>
                            <li>
                                <a href="1800-001-658.html"><i class="fas fa-phone"></i>
                                    <span>1800-001-658</span>
                                </a>
                            </li>
                            <li>
                                <a href="mailto:info@plumwellness.com"><i class="fas fa-envelope"></i>
                                    <span>info@plumwellness.com</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 align-self-center">
                        <span class="pq-copyright"> Powered by Curtinatect.com.</span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="fixed-icon-section">
    ...
    <a href="tel:91+9988993972" class="icon"><i class="fa-solid fa-phone mgr"></i> Call to an Expert </a>
...
<!-- Mirrored from peacefulqode.co.in/themes/nutritius/html/parasitic-nutrition.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Sep 2024 03:48:03 GMT -->
