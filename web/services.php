         ...
         <div class="col-xl-3 col-lg-6 col-md-6 wow  fadeInUp animated"
            ...
            <div class="pq-icon-box pq-style-2 txt-center">
               ...
               <div class="pq-icon-box-content mb-30">
                  <h6 class="service-txt">PCOS </h6>
                  <p class="pq-icon-box-description">
                     Break free from PCOS challenges and embrace a healthier you. Reclaim your vitality, unlock your
                     potential, and start your wellness journey today!
                  </p>
